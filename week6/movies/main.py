...
# Executing the query to get a DataFrame
...
# Note that this is just a dictionary.
axis_map = {
    "Tomato Meter": "Meter",
...
# For the nice little box
# that pops up when you hover
# over a dot
...
# Change the values that get plotted
def update():
    df = select_movies()
...
# Note the difference here in the
# call to on_change
...
# Finally, this is just as before.
curdoc().add_root(l)
curdoc().title = "Movies"
